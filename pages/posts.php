<?php 
    ...
    $how_much_posts = DB::query('SELECT COUNT(id) AS items FROM posts WHERE accepted=1');
    ...
    $posts = DB::query('SELECT * FROM posts WHERE accepted=1 LIMIT '.$start_from.','.$per_page);
?>
...
<head>
    ...
    <title>Wpisy - <?php echo DB::get_settings('website_title') ?></title>
            ...
            <div class="last_websites">
                <?php foreach($posts as $post) : ?>
                    <div class="single_website">
                        <div class="img">
                            <a href="/strona/<?php echo $post['id'].'/'.$post['slug'] ?>">
